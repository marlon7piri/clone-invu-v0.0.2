...
const Footer = () => {
  return (
 <div className='w-full h-max bg-slate-900 text-slate-50 text-center p-4 flex justify-center gap-4 z-50'>
    <p>Hecho con <span className='text-2xl'>❤️ </span>por Marlon  Rodriguez Rivera</p> 
    
    <section class="flex justify-center items-center gap-4">
  <a
    href="https://github.com/marlon7piri" target='_blank'
  ...
  <a
    href="https://www.linkedin.com/in/marlon-rodriguez-rivera/" target='_blank'
    className="group flex justify-center p-2 rounded-md drop-shadow-xl bg-gradient-to-r from-sky-500 to-black text-white font-semibold hover:translate-y-3 transition-all duration-500 hover:from-[#331029] hover:to-[#310413]"
  >
